...
var ASM_CONSTS = {
  96488: () => { if (document.fullscreenElement) return 1; },  
 96534: () => { return Module.canvas.width; },  
 96566: () => { return parseInt(Module.canvas.style.width); },  
 ...
 96760: () => { return Module.canvas.width; },  
 96792: () => { return screen.width; },  
 96817: () => { document.exitFullscreen(); },  
 96844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 96977: () => { return window.innerWidth; },  
 97003: () => { return window.innerHeight; },  
 97030: () => { if (document.fullscreenElement) return 1; },  
 97076: () => { return Module.canvas.width; },  
 97108: () => { return parseInt(Module.canvas.style.width); },  
 97156: () => { if (document.fullscreenElement) return 1; },  
 97202: () => { return Module.canvas.width; },  
 97234: () => { return screen.width; },  
 97259: () => { return window.innerWidth; },  
 97285: () => { return window.innerHeight; },  
 97312: () => { if (document.fullscreenElement) return 1; },  
 97358: () => { return Module.canvas.width; },  
 97390: () => { return screen.width; },  
 97415: () => { document.exitFullscreen(); },  
 97442: () => { if (document.fullscreenElement) return 1; },  
 97488: () => { return Module.canvas.width; },  
 97520: () => { return parseInt(Module.canvas.style.width); },  
 97568: () => { document.exitFullscreen(); },  
 97595: ($0) => { Module.canvas.style.opacity = $0; },  
 97633: () => { return screen.width; },  
 97658: () => { return screen.height; },  
 97684: () => { return window.screenX; },  
 97711: () => { return window.screenY; },  
 97738: () => { return window.devicePixelRatio; },  
 97774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 97827: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 97878: () => { Module.canvas.style.cursor = 'none'; },  
 97915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98171: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98222: () => { if (document.fullscreenElement) return 1; },  
 98268: () => { return window.innerWidth; },  
 98294: () => { return window.innerHeight; },  
 98321: () => { if (document.pointerLockElement) return 1; }
};
